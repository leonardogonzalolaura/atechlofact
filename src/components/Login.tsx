...
const Login = () => {
    ...
    const handleGoogleLogin = () => {
        // Redirigir a tu API para manejar Google OAuth (mismo endpoint que registro)
        ...
        <div className="max-w-md w-full mx-auto bg-white p-8 rounded-xl shadow-2xl animate-fade-in-scale" style={{transform: 'scale(0.8)', transformOrigin: 'center'}}>
            ...
            <div className="mt-8 text-center space-y-3">
                ...
                <button 
                    ...
                    disabled={isLoading}
                    className="w-full bg-white border border-gray-300 text-gray-700 py-3 px-6 rounded-lg hover:bg-gray-50 transition-all duration-300 disabled:opacity-50 font-semibold flex items-center justify-center space-x-2 mb-4"
                >
