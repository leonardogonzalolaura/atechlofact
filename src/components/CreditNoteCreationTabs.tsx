...
const CreditNoteCreation = ({ isOpen, onClose }: CreditNoteCreationProps) => {
  ...
  // Estados para búsquedas (reutilizando lógica de factura)
  ...
  // Funciones reutilizadas (simplificadas)
  const addItem = () => {
  ...
  const handleSave = () => {
    console.log('Guardando nota de crédito...', { creditNoteData, items, subtotal, igv, total });
  ...
  return (
    <div className="fixed inset-0 bg-white bg-opacity-20 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-backdrop-enter">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[95vh] flex flex-col animate-modal-enter">
        <DocumentHeader title="Nueva Nota de Crédito" onClose={onClose} />
        ...
        <div className="flex-1 p-4 sm:p-6 overflow-y-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
                    <select
                      value={creditNoteData.documentoReferencia.tipo}
                      onChange={(e) => setCreditNoteData({
                        ...creditNoteData,
                        documentoReferencia: {...creditNoteData.documentoReferencia, tipo: e.target.value}
                      })}
                    ...
                    <input
                      type="date"
                      value={creditNoteData.documentoReferencia.fecha}
                      onChange={(e) => setCreditNoteData({
                        ...creditNoteData,
                        documentoReferencia: {...creditNoteData.documentoReferencia, fecha: e.target.value}
                      })}
                      className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900"
                    />
                  </div>
          ...
          {activeTab === 'observaciones' && (
            <InvoiceObservaciones 
              invoiceData={{observaciones: creditNoteData.observaciones}}
              setInvoiceData={(data) => setCreditNoteData(prev => ({...prev, observaciones: data.observaciones}))}
            />
          )}
        </div>
        ...
        <NavigationButtons
          ...
          onClose={onClose}
          onSave={handleSave}
          saveButtonText="Generar Nota de Crédito"
          saveButtonIcon={
